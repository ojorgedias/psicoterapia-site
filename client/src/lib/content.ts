...
export const institutionalPages: Page[] = [
  {
    ...
    slug: "home",
    description: "Atendimento psicoterapêutico online focado em autoconhecimento profundo, filosofia e pensamento integrativo",
    route: "/",
  ...
  },
  {
    ...
    title: "Sobre",
    slug: "sobre",
    description: "Conheça a abordagem clínica e a formação do psicoterapeuta",
    route: "/sobre",
    cluster: "institutional",
    order: 2,
  },
...
export const cluster4Pages: Page[] = [
  {
    ...
    slug: "psicoterapia-espiritualidade",
...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    description: "Evitar o bypassing espiritual e integrar psicoterapia com espiritualidade",
