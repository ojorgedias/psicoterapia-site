        ...
        <section className="px-4 max-w-4xl mx-auto py-12">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Autossabotagem não é um comportamento isolado. É uma manifestação de <Link href="/conceitos-fundamentais" className="text-primary hover:underline">regras invisíveis</Link> que você internalizou, frequentemente sem perceber. Essas regras governam o que você acredita ser "permitido" para você, qual é seu "lugar" no mundo, e o que significa ser leal aos seus.
            </p>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
              <Link href="/terapia/casais/padroes-familiares" className="text-primary hover:underline">Lealdades Invisíveis</Link>: O Coração da Autossabotagem
            </h2>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
              ...
              <a href="/autossabotagem-trabalho-carreira" className="p-6 border border-slate-200 rounded-lg hover:shadow-lg transition-shadow block">
                ...
                <p className="text-sm text-slate-600">Como <Link href="/conceitos-fundamentais" className="text-primary hover:underline">regras invisíveis</Link> limitam sua ascensão profissional</p>
              </a>
            ...
            <p className="text-slate-700 leading-relaxed">
              Se você está pronto para explorar seus padrões de autossabotagem de forma mais profunda, considere agendar uma sessão de terapia. Juntos, podemos fazer uma arqueologia pessoal de seus pressupostos e descobrir as <Link href="/conceitos-fundamentais" className="text-primary hover:underline">regras invisíveis</Link> que governam seu sucesso.
            </p>
          </div>
        </section>
        ...
        <section className="bg-slate-900 text-white py-16 px-4 mt-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-300 mb-8">
              Agende uma sessão e comece a desconstruir as <Link href="/conceitos-fundamentais" className="text-primary hover:underline">regras invisíveis</Link> que governam seu sucesso.
            </p>
