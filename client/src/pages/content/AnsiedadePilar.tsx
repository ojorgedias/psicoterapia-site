      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <section className="pt-20 pb-12 px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-slate-900 mb-6 leading-tight">
            Ansiedade: Do <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> à Integração
          </h1>
        ...
        <section className="px-4 max-w-4xl mx-auto py-12">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
              O <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link>: Entendendo a Ansiedade
            </h2>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              O problema é que seu <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> está ativado por ameaças que não são físicas: julgamento social, incerteza, perda de controle. Seu corpo reage como se um mamute real estivesse vindo, mas a ameaça é psicológica.
            </p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
              <Link href="/conceitos-fundamentais"><a className="text-primary hover:underline">Regras Invisíveis</a></Link> e Ansiedade
            </h2>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Essas regras são tão naturalizadas que você nem percebe que está vivendo dentro delas. Você apenas sente o <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> sendo ativado.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Trabalhar com ansiedade não é "eliminar" o <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link>. É integrar. É criar diálogo entre o corpo, a mente e a intuição.
            </p>
            <p className="text-slate-700 leading-relaxed mb-6">
              Isso envolve:
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              <strong>Ansiedade</strong> é o <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> em pânico. É reativa, descontrolada, baseada em ameaças imaginadas.
            </p>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
              <a href="/sintomas-fisicos-ansiedade-infarto" className="p-6 border border-slate-200 rounded-lg hover:shadow-lg transition-shadow block">
                ...
                <p className="text-sm text-slate-600">Entendendo a ativação do <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link></p>
              </a>
              <a href="/ansiedade-domingo-noite" className="p-6 border border-slate-200 rounded-lg hover:shadow-lg transition-shadow block">
                ...
                <p className="text-sm text-slate-600"><Link href="/conceitos-fundamentais"><a className="text-primary hover:underline">Regras invisíveis</a></Link> e obrigação</p>
              </a>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Trabalhar com ansiedade é um processo de integração, não de eliminação. O <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> sempre estará lá — é parte de você. O objetivo é aprender a dialogar com ele, a entender quando está realmente em perigo e quando está respondendo a ameaças imaginárias.
            </p>
            <p className="text-slate-700 leading-relaxed">
              Se você está lutando com ansiedade, considere agendar uma sessão. Juntos, podemos explorar suas <Link href="/conceitos-fundamentais"><a className="text-primary hover:underline">regras invisíveis</a></Link> e aprender a integrar o <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link> com o resto de você.
            </p>
          </div>
        </section>
        ...
        <section className="bg-slate-900 text-white py-16 px-4 mt-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">Pronto para Integrar Seu <Link href="/ansiedade"><a className="text-primary hover:underline">Mamute Interior</a></Link>?</h2>
