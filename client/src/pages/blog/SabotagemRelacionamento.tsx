...
export default function SabotagemRelacionamento() {
  useEffect(() => {
    document.title = 'Como Parar de Me Sabotar no Relacionamento Amoroso | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Entenda a raiz invisível dos conflitos no relacionamento. Descubra como regras invisíveis sabotam seu amor.');
  }, []);
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <section className="px-4 max-w-4xl mx-auto py-12">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Quando você, na vida adulta, encontra um relacionamento seguro e tranquilo, a sua mente entra em pânico. A paz soa como uma ameaça, porque é um território desconhecido. A autossabotagem é, paradoxalmente, um mecanismo de defesa: você cria o caos na relação atual para voltar ao cenário de tensão que lhe é familiar. Você não está fugindo do parceiro; você está sendo leal a uma dor do passado. É isso que investigamos a fundo na <a href="/padroes-familiares" className="text-blue-600 hover:underline">psicoterapia voltada para padrões familiares destrutivos</a>.
            </p>

            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
              A Arqueologia Pessoal no amor
            </h2>
            <p className="text-slate-700 leading-relaxed mb-6">
              Muitas pessoas tentam resolver a autossabotagem prometendo a si mesmas que "dessa vez vai ser diferente" ou lendo dicas de comunicação para casais. Mas a força de vontade não é páreo para o inconsciente. Para parar de se sabotar, é necessário realizar o que conceituo como a Arqueologia Pessoal de Pressupostos.
            </p>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
              Desmontando a máquina da repetição
            </h2>
            <p className="text-slate-700 leading-relaxed mb-6">
              A cura para a autossabotagem no amor não é mágica, é analítica. O objetivo da terapia não é forçar você a ficar em um relacionamento a qualquer custo, mas garantir que a decisão de ficar ou partir seja tomada por você, e não pelos seus traumas.
            </p>
            <p className="text-slate-700 leading-relaxed mb-6">
            ...
            <div className="mt-12 p-8 bg-slate-100 rounded-lg">
              ...
              <ul className="space-y-3">
                ...
                <li><a href="/narcisismo" className="text-blue-600 hover:underline">Narcisismo: Compreensão e Libertação</a></li>
        ...
        <section className="bg-slate-900 text-white py-16 px-4 mt-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">Pronto para Investigar Suas Dinâmicas Afetivas?</h2>
            <p className="text-lg text-slate-300 mb-8">
              Agende uma sessão e comece a trabalhar com autossabotagem de forma genuína.
            </p>
