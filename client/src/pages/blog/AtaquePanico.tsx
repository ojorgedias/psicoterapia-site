...
export default function AtaquePanico() {
  useEffect(() => {
    document.title = 'Como acalmar uma crise de ansiedade forte sozinho: O limite entre o alívio e o tratamento | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Aprenda técnicas imediatas e o trabalho profundo necessário para resolver crises.');
  }, []);
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <section className="pt-20 pb-12 px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-slate-900 mb-6 leading-tight">
            Como acalmar uma crise de ansiedade forte sozinho: O limite entre o alívio e o tratamento
          </h1>
        </section>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mt-12 p-8 bg-slate-100 rounded-lg">
              ...
              <ul className="space-y-3">
                <li><a href="/ansiedade" className="text-blue-600 hover:underline">Voltar ao cluster temático</a></li>
              </ul>
            </div>
          </div>
        </section>
