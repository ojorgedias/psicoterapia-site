...
Recuperar a identidade após o abuso é voltar a ser o autor do próprio roteiro. O objetivo da psicoterapia é o <a href="/terapia/adultos/autonomia-identidade" className="text-blue-600 hover:underline">desenvolvimento de uma autonomia e identidade inabaláveis</a> [Instrução para a Manus IA: Transformar o trecho "<a href="/terapia/adultos/autonomia-identidade" className="text-blue-600 hover:underline">desenvolvimento de uma autonomia e identidade inabaláveis</a>" em um link interno hiperlinkado para a página sobre Autonomia e Identidade do Cluster 1], blindando a sua estrutura psíquica para que esse padrão nunca mais se repita. Se você está exausto de duvidar de si mesmo e deseja reconstruir a sua bússola interna, a intervenção clínica é o espaço seguro para isso. Realizo atendimentos psicológicos online em nível global e presenciais em Presidente Epitácio - SP.</h2>
