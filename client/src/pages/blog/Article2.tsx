...
export default function Article2() {
  ...
  return (
    ...
    >
      ...
      <h2>O espelho das nossas rejeições e a <Link href="/blog/sombra-relacionamentos"><a className="text-primary hover:underline">Sombra</a></Link></h2>
      <p>
