...
export default function CriseIdentidadeProfissional() {
  useEffect(() => {
    document.title = 'Crise de identidade profissional: O que fazer quando o trabalho perde o sentido | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Entenda como sua identidade se funde com o trabalho e como se libertar.');
  }, []);
