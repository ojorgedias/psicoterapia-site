...
export default function DepressionVsCrise() {
  useEffect(() => {
    document.title = 'Qual a diferença entre depressão e crise existencial? O perigo do diagnóstico raso | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Aprenda a diferenciar depressão de crise existencial para tratamento adequado.');
  }, []);
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mt-12 p-8 bg-slate-100 rounded-lg">
              ...
              <ul className="space-y-3">
                <li><a href="/crise-existencial" className="text-blue-600 hover:underline">Voltar ao cluster temático</a></li>
              </ul>
            </div>
          </div>
        </section>
