...
export default function QuebrarCiclosFamiliares() {
  useEffect(() => {
    document.title = 'Como quebrar ciclos familiares tóxicos na fase adulta: O preço da autonomia | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Explore como desativar lealdades invisíveis e construir novos padrões.');
  }, []);
