...
A resistência em manter o distanciamento raramente é sobre o amor pela família real que o paciente tem. É sobre o luto pela família idealizada que ele nunca teve e percebeu que nunca terá. Voltar para o ambiente abusivo é uma forma de <Link href="/autossabotagem"><a className="text-primary hover:underline">autossabotagem</a></Link> e padrões de repetição, alimentada pela esperança infantil de que, se você ceder mais uma vez, eles finalmente o amarão como você merece.</h2><p className="text-slate-700 leading-relaxed mb-6">Para suportar o distanciamento, o paciente precisa adotar o "<Link href="/conceitos-fundamentais"><a className="text-primary hover:underline">manto da ignorância</a></Link>" e suspender a sua necessidade de ter razão ou de fazer os familiares entenderem os seus motivos. Eles provavelmente nunca entenderão, e a maturidade exige que você fique em paz com essa incompletude.</p><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">A travessia para a saúde mental
