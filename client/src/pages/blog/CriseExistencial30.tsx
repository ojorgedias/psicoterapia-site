...
<h1 classname="text-5xl font-bold text-slate-900 mb-6 leading-tight">
            Sintomas de <link classname="text-primary hover:underline" href="/crise-existencial"/>crise existencial aos 30 anos: O colapso do roteiro ideal
          </h1>
</section>
