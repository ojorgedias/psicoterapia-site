...
export default function CriseExistencial30() {
  useEffect(() => {
    document.title = 'Sintomas de crise existencial aos 30 anos: O colapso do roteiro ideal | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Descubra o que significa uma crise existencial e como ela diferencia de depressão.');
  }, []);
