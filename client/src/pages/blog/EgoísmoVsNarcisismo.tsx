...
<p className="text-slate-700 leading-relaxed mb-6">Na minha prática clínica, é muito frequente receber pacientes na faixa dos 30 ou 40 anos em estado de choque e frustração profunda após uma constatação dura: "Eu jurei a mim mesmo que nunca seria como o meu pai (ou minha mãe), mas acabei de ter a exata mesma atitude que eles". A internet costuma tratar a repetição de comportamentos abusivos ou disfuncionais como uma simples falta de vontade de mudar. Contudo, a psicoterapia profunda revela que quebrar ciclos familiares tóxicos na fase adulta exige o enfrentamento de uma das forças mais primitivas da nossa psique: a lealdade invisível ao nosso sistema de origem.
