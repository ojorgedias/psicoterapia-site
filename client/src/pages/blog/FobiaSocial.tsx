...
export default function FobiaSocial() {
  useEffect(() => {
    document.title = 'Fobia Social e a Necessidade de Aprovação: A biologia do medo da rejeição | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Entenda a raiz neurobiológica do medo social e como atualizar seu sistema de defesa.');
  }, []);
