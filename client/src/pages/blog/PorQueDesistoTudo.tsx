...
export default function PorQueDesistoTudo() {
  useEffect(() => {
    ...
    descMeta.setAttribute('content', 'Por que eu desisto de tudo que começo? A psicologia por trás do ciclo de abandono');
  }, []);
...
A angústia do eterno iniciante
...
</p><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">A ilusão da preguiça e a fase da Antítese
A desistência raramente acontece por falta de vontade de vencer; ela acontece pelo terror de falhar ou, ironicamente, pelo terror de dar certo. Quando começamos algo novo, estamos cheios de idealizações. Mas assim que o processo exige esforço real, nós nos deparamos com a nossa própria ignorância e limitação. Esse é o momento do atrito, a fase que a filosofia chama de Antítese.</h2><p className="text-slate-700 leading-relaxed mb-6">Desistir no meio do caminho é uma estratégia para não lidar com a frustração de não ser perfeito. É muito mais confortável para o ego dizer "eu não terminei aquele projeto porque perdi o interesse" do que terminá-lo e descobrir que ele ficou mediano e será alvo de críticas. O abandono protege a sua imagem idealizada, mas mantém você paralisado na vida real.</p><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">O medo de forjar a própria régua
Além do medo do erro, há uma questão existencial mais profunda. Quando você leva um projeto até o fim, você muda de patamar. Você inevitavelmente se destaca, cresce e, com isso, corre o risco de não pertencer mais ao mesmo grupo ou de não caber mais nas expectativas da sua família. Desistir é uma forma de <a href="/autossabotagem" className="text-blue-600 hover:underline">autossabotagem e padrão de repetição</a> [Instrução para a Manus IA: Transformar o trecho "<a href="/autossabotagem" className="text-blue-600 hover:underline">autossabotagem e padrão de repetição</a>" em um link interno hiperlinkado para a página de Serviço sobre Autossabotagem do Cluster 1] que garante que você permaneça no seu lugar de sempre, evitando o peso da responsabilidade de ser o autor da própria história.</h2><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">Suportando o desconforto de não saber
Para quebrar o ciclo do abandono, você não precisa de mais planilhas de organização ou discursos motivacionais. Você precisa desenvolver a tolerância ao desconforto. Na terapia, aplicamos o que chamo de Técnica do Manto da Ignorância: ensinamos o paciente a suportar a fase em que ele é apenas um aprendiz vulnerável, desarmando a exigência irreal de perfeição imediata.</h2><p className="text-slate-700 leading-relaxed mb-6">Sustentar o "meio do caminho", com todas as suas dúvidas e tédios, é o único trajeto para o <a href="/terapia/adultos/autonomia-identidade" className="text-blue-600 hover:underline">desenvolvimento de uma autonomia e identidade inabaláveis</a> [Instrução para a Manus IA: Transformar o trecho "<a href="/terapia/adultos/autonomia-identidade" className="text-blue-600 hover:underline">desenvolvimento de uma autonomia e identidade inabaláveis</a>" em um link interno hiperlinkado para a página sobre Autonomia e Identidade do Cluster 1]. Se a frustração de nunca terminar o que começa está esgotando a sua vitalidade, a psicoterapia é o espaço de investigação para desconstruir essa paralisia. Ofereço atendimento psicológico online para o Brasil e exterior, além de sessões presenciais em Presidente Epitácio - SP.</p>
