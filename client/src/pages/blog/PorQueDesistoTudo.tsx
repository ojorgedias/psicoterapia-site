...
export default function PorQueDesistoTudo() {
  useEffect(() => {
    document.title = 'Por que eu desisto de tudo que começo? | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Descubra por que abandona projetos e como quebrar esse ciclo de desistência crônica.');
  }, []);
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <section className="bg-slate-900 text-white py-16 px-4 mt-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">Pronto para Quebrar o Ciclo?</h2>
            <p className="text-lg text-slate-300 mb-8">
              Agende uma sessão e comece a trabalhar com o abandono crônico.
            </p>
