...
export default function AutossabotagemInconsciente() {
  ...
  useEffect(() => {
    document.title = 'Autossabotagem: Manifestação da sombra e dinâmicas de poder | Psicoterapeuta Jorge Dias';
...
<p>
            A autossabotagem não é um mecanismo de proteção simples. É mais complexa. Ela é a manifestação de partes de si mesmo que você rejeita (a <Link className="text-primary hover:underline" href="/blog/sombra-relacionamentos">sombra)</Link> combinada com uma dinâmica onde você se sente simultaneamente onipotente (capaz de tudo) e impotente (incapaz de nada). Quando você se aproxima do sucesso, essa dinâmica se ativa e você cria obstáculos.
          </p>
<p>
...
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
<Link className="text-primary hover:underline" href="/terapia/casais/padroes-familiares">Lealdades</Link> Invisíveis: O Entrelaçamento Familiar
          </h2>
<p>
...
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
            A <Link className="text-primary hover:underline" href="/blog/sombra-relacionamentos">Sombra:</Link> O Que Você Rejeita em Si Mesmo
          </h2>
<p>
...
<p>
            Você foi criado para ser "gentil" e "educado". Sua agressividade é <Link className="text-primary hover:underline" href="/blog/sombra-relacionamentos">sombra.</Link> Você a rejeita. Mas sucesso muitas vezes exige agressividade—estabelecer limites, dizer não, defender seus interesses. Quando você se aproxima do sucesso, seu inconsciente percebe que você precisaria acessar essa agressividade rejeitada. Então você sabota para evitar ter que integrar essa parte de si mesmo.
          </p>
<h3 className="text-xl font-semibold text-primary mt-6">Exemplo: A Ambição</h3>
<p>
            Você foi criado em um ambiente onde ambição era vista como "ganância" ou "egoísmo". Sua ambição é <Link className="text-primary hover:underline" href="/blog/sombra-relacionamentos">sombra.</Link> Você a rejeita. Mas sucesso exige ambição. Quando você se aproxima do sucesso, você sente que está se tornando a pessoa que você sempre desprezou. Então você sabota para manter sua autoimagem de pessoa "humilde" e "desapegada".
          </p>
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Autossabotagem vs <Link className="text-primary hover:underline" href="/blog/spiritual-bypass">Spiritual</Link> Bypass
          </h2>
<p>
...
<p>
            A verdadeira espiritualidade não rejeita o mundo material ou o sucesso. Ela integra. Você pode ser bem-sucedido E espiritual. Você pode ter dinheiro E valores autênticos. Quando você usa espiritualidade para justificar fracasso, você está fazendo <Link className="text-primary hover:underline" href="/blog/spiritual-bypass">spiritual</Link> bypass, não desenvolvimento genuíno.
          </p>
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
...
<Link href="/terapia/adultos/autossabotagem"></Link>
...
<Link href="/conceitos-fundamentais"></Link>
<a className="p-4 bg-card border border-border rounded-lg hover:border-primary transition-colors group">
<h4 className="font-semibold text-foreground group-hover:text-primary transition-colors mb-2">
                  Conceitos Fundamentais
                </h4>
<p className="text-sm text-muted-foreground">Entenda a <Link className="text-primary hover:underline" href="/blog/sombra-relacionamentos">sombra,</Link> <Link className="text-primary hover:underline" href="/terapia/casais/padroes-familiares">lealdades</Link> invisíveis e mais</p>
<div className="flex items-center gap-2 text-primary mt-2 text-sm">
<span>Explorar</span>
<ArrowRight size="{16}" />
</div>
