      ...
      <article className="container max-w-3xl py-12 md:py-20">
        ...
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
            Autossabotagem Inconsciente: A Manifestação da <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">Sombra</Link> e as Dinâmicas de Poder
          </h1>
        ...
        <div className="prose prose-invert max-w-none text-foreground space-y-6">
          ...
          <p>
            A autossabotagem não é um mecanismo de proteção simples. É mais complexa. Ela é a manifestação de partes de si mesmo que você rejeita (a <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">sombra</Link>) combinada com uma dinâmica onde você se sente simultaneamente onipotente (capaz de tudo) e impotente (incapaz de nada). Quando você se aproxima do sucesso, essa dinâmica se ativa e você cria obstáculos.
          </p>
          ...
          <h2 className="text-2xl font-display font-bold text-foreground mt-8">
            <Link href="/terapia/casais/padroes-familiares" className="text-primary hover:underline">Lealdades Invisíveis</Link>: O Entrelaçamento Familiar
          </h2>
          ...
          <h2 className="text-2xl font-display font-bold text-foreground mt-8">
            A <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">Sombra</Link>: O Que Você Rejeita em Si Mesmo
          </h2>
          ...
          <p>
            Você foi criado para ser "gentil" e "educado". Sua agressividade é <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">sombra</Link>. Você a rejeita. Mas sucesso muitas vezes exige agressividade—estabelecer limites, dizer não, defender seus interesses. Quando você se aproxima do sucesso, seu inconsciente percebe que você precisaria acessar essa agressividade rejeitada. Então você sabota para evitar ter que integrar essa parte de si mesmo.
          </p>

          <h3 className="text-xl font-semibold text-primary mt-6">Exemplo: A Ambição</h3>
          <p>
            Você foi criado em um ambiente onde ambição era vista como "ganância" ou "egoísmo". Sua ambição é <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">sombra</Link>. Você a rejeita. Mas sucesso exige ambição. Quando você se aproxima do sucesso, você sente que está se tornando a pessoa que você sempre desprezou. Então você sabota para manter sua autoimagem de pessoa "humilde" e "desapegada".
          </p>

          <h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Autossabotagem vs <Link href="/blog/spiritual-bypass" className="text-primary hover:underline">Spiritual Bypass</Link>
          </h2>
          ...
          <p>
            A verdadeira espiritualidade não rejeita o mundo material ou o sucesso. Ela integra. Você pode ser bem-sucedido E espiritual. Você pode ter dinheiro E valores autênticos. Quando você usa espiritualidade para justificar fracasso, você está fazendo <Link href="/blog/spiritual-bypass" className="text-primary hover:underline">spiritual bypass</Link>, não desenvolvimento genuíno.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link href="/conceitos-fundamentais">
              <a className="p-4 bg-card border border-border rounded-lg hover:border-primary transition-colors group">
                ...
                <p className="text-sm text-muted-foreground">Entenda a <Link href="/blog/sombra-relacionamentos" className="text-primary hover:underline">sombra</Link>, <Link href="/terapia/casais/padroes-familiares" className="text-primary hover:underline">lealdades invisíveis</Link> e mais</p>
                <div className="flex items-center gap-2 text-primary mt-2 text-sm">
                  <span>Explorar</span>
                  <ArrowRight size={16} />
                </div>
