...
<breadcrumbs '="" 'autossabotagem="" 'blog',="" blog'="" href:="" inconsciente'="" items="{[{" label:="" {="" },="" }]}=""></breadcrumbs>
<article classname="container max-w-3xl py-12 md:py-20">
        {/* Header */}
        <div classname="mb-8">
<h1 classname="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
            Autossabotagem Inconsciente: A Manifestação da <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>Sombra e as Dinâmicas de Poder
          </h1>
...
<p>
            A autossabotagem não é um mecanismo de proteção simples. É mais complexa. Ela é a manifestação de partes de si mesmo que você rejeita (a <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>sombra) combinada com uma dinâmica onde você se sente simultaneamente onipotente (capaz de tudo) e impotente (incapaz de nada). Quando você se aproxima do sucesso, essa dinâmica se ativa e você cria obstáculos.
          </p>
<p>
...
<h2 classname="text-2xl font-display font-bold text-foreground mt-8">
<link classname="text-primary hover:underline" href="/terapia/casais/padroes-familiares"/>Lealdades Invisíveis: O Entrelaçamento Familiar
          </h2>
<p>
...
<h2 classname="text-2xl font-display font-bold text-foreground mt-8">
            A <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>Sombra: O Que Você Rejeita em Si Mesmo
          </h2>
<p>
...
<p>
            Você foi criado para ser "gentil" e "educado". Sua agressividade é <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>sombra. Você a rejeita. Mas sucesso muitas vezes exige agressividade—estabelecer limites, dizer não, defender seus interesses. Quando você se aproxima do sucesso, seu inconsciente percebe que você precisaria acessar essa agressividade rejeitada. Então você sabota para evitar ter que integrar essa parte de si mesmo.
          </p>
<h3 classname="text-xl font-semibold text-primary mt-6">Exemplo: A Ambição</h3>
<p>
            Você foi criado em um ambiente onde ambição era vista como "ganância" ou "egoísmo". Sua ambição é <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>sombra. Você a rejeita. Mas sucesso exige ambição. Quando você se aproxima do sucesso, você sente que está se tornando a pessoa que você sempre desprezou. Então você sabota para manter sua autoimagem de pessoa "humilde" e "desapegada".
          </p>
<h2 classname="text-2xl font-display font-bold text-foreground mt-8">
            Autossabotagem vs <link classname="text-primary hover:underline" href="/blog/spiritual-bypass"/>Spiritual Bypass
          </h2>
<p>
...
<p>
            A verdadeira espiritualidade não rejeita o mundo material ou o sucesso. Ela integra. Você pode ser bem-sucedido E espiritual. Você pode ter dinheiro E valores autênticos. Quando você usa espiritualidade para justificar fracasso, você está fazendo <link classname="text-primary hover:underline" href="/blog/spiritual-bypass"/>spiritual bypass, não desenvolvimento genuíno.
          </p>
<h2 classname="text-2xl font-display font-bold text-foreground mt-8">
...
<p classname="text-foreground mb-4">
              A psicoterapia oferece um espaço seguro para fazer essa investigação de forma rigorosa e compassiva. Ofereço atendimento especializado em autossabotagem, <link classname="text-primary hover:underline" href="/padroes-familiares"/>padrões familiares e integração da <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>sombra. Atendimento online para todo o país e .
            </p>
...
<p classname="text-sm text-muted-foreground">Entenda a <link classname="text-primary hover:underline" href="/blog/sombra-relacionamentos"/>sombra, <link classname="text-primary hover:underline" href="/terapia/casais/padroes-familiares"/>lealdades invisíveis e mais</p>
<div classname="flex items-center gap-2 text-primary mt-2 text-sm">
<span>Explorar</span>
<arrowright size="{16}"></arrowright>
</div>
