    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="container max-w-3xl py-12 md:py-20">
        ...
        <div className="prose prose-invert max-w-none text-foreground space-y-6">
          ...
          <h3 className="text-xl font-semibold text-primary mt-6">Lealdades Invisíveis</h3>
          <p>
          ...
          <h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Relacionamentos com Narcisismo Familiar
          </h2>
          <p>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-6 mt-8">
            <h3 className="text-xl font-semibold text-foreground mb-3">Especializados em Padrões Familiares</h3>
