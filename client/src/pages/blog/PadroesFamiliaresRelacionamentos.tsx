...
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Por Que Repetimos <Link className="text-primary hover:underline" href="/padroes-familiares">Padrões</Link> Familiares?
          </h2>
<p>
...
<h3 className="text-xl font-semibold text-primary mt-6"><Link className="text-primary hover:underline" href="/terapia/casais/padroes-familiares">Lealdades</Link> Invisíveis</h3>
<p>
...
<h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Relacionamentos com <Link className="text-primary hover:underline" href="/narcisismo">Narcisismo</Link> Familiar
          </h2>
<p>
...
<h3 className="text-xl font-semibold text-foreground mb-3">Especializados em <Link className="text-primary hover:underline" href="/padroes-familiares">Padrões</Link> Familiares</h3>
...
<Link href="/terapia/casais/padroes-familiares"></Link>
<a className="p-4 bg-card border border-border rounded-lg hover:border-primary transition-colors group">
<h4 className="font-semibold text-foreground group-hover:text-primary transition-colors mb-2">
                  Serviço: <Link className="text-primary hover:underline" href="/padroes-familiares">Padrões</Link> Familiares
                </h4>
