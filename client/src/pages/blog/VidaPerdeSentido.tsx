...
export default function VidaPerdeSentido() {
  useEffect(() => {
    document.title = 'O que fazer quando a vida perde o sentido: A visão da psicologia clínica | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Explore como forjar um novo sentido quando as certezas antigas desabam.');
  }, []);
