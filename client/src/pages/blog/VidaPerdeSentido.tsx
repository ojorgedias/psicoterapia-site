...
export default function VidaPerdeSentido() {
  useEffect(() => {
    ...
    descMeta.setAttribute('content', 'O que fazer quando a vida perde o sentido: A visão da psicoterapia clínica');
  }, []);
...
<h1 className="text-5xl font-bold text-slate-900 mb-6 leading-tight">
            O que fazer quando a vida perde o sentido: A visão da psicoterapia clínica
          </h1>
</section>
<section className="px-4 max-w-4xl mx-auto py-12">
<div className="prose prose-lg max-w-none">
<p className="text-slate-700 leading-relaxed mb-6">"Eu tenho tudo para ser feliz, mas sinto um vazio absoluto. O que eu faço?". Escuto essa exata formulação semanalmente na minha prática clínica. Quando um paciente digita no Google buscando saber o que fazer quando a vida perde o sentido e adiciona a palavra "psicoterapia" à busca, ele não está procurando frases de motivação rasas; ele está pedindo uma intervenção estrutural. Na clínica de profundidade, compreendemos que a perda de sentido não é uma falha no seu cérebro, mas um evento psíquico necessário. É o som da fundação da sua vida rachando porque o roteiro que você seguia não suporta mais a pessoa que você se tornou.

</p><p>O desmoronamento das certezas emprestadas
O vazio existencial costuma atingir com mais violência as pessoas que foram excelentes cumpridoras de regras. Desde a infância, nós recebemos da família e da cultura um manual com "Réguas Prontas" sobre o que deve ter valor: casar até tal idade, alcançar um cargo específico, acumular bens. O indivíduo passa anos correndo atrás dessas metas.</p><p className="text-slate-700 leading-relaxed mb-6">A crise se instaura no momento exato em que a meta é atingida (ou quando se percebe que ela é inatingível) e a promessa de completude falha miseravelmente. Observo no consultório que a dor da perda de sentido é, na verdade, o luto pelas certezas emprestadas. Você descobre que passou a vida inteira terceirizando o seu pensamento e vivendo os valores de outras pessoas. É uma fase de profunda desorientação que exige uma investigação severa, abordada diretamente no tratamento de <Link className="text-primary hover:underline" href="/crise-existencial">crise</Link> existencial.</p><p>O erro de preencher o vazio rapidamente
O instinto imediato de quem sente esse vazio é tentar tapá-lo com urgência. O paciente troca de emprego impulsivamente, termina casamentos de forma reativa ou mergulha em fanatismos (sejam eles religiosos, políticos ou hiperprodutivos). Essa fuga apenas adia o problema.</p><p className="text-slate-700 leading-relaxed mb-6">Como psicoterapeuta, a minha primeira intervenção é ensinar o paciente a suportar o desconforto de não ter respostas. É o que conceituo como vestir o "<Link className="text-primary hover:underline" href="/conceitos-fundamentais">manto</Link> da ignorância". Admitir conscientemente que você não sabe quem é ou o que quer, sem entrar em pânico, é o pré-requisito absoluto para que a verdadeira investigação de si mesmo comece. Apenas no vácuo do "não-saber" é que os seus desejos autênticos conseguem emergir.</p><p>Forjando o próprio sentido
...
<a className="inline-block bg-white text-slate-900 font-bold py-3 px-8 rounded-lg hover:bg-slate-100 transition-colors" href="https://wa.me/5541985155583?text=Olá, estava lendo O%20que%20fazer%20quando%20a%20vida%20perde%20o%20sentido%3A%20A%20visão%20da%20psicoterapia%20clínica e gostaria de agendar uma sessão.">
