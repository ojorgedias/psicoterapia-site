...
export default function Article1() {
  ...
  return (
    ...
    >
      ...
      <p>
        A diferença reside na qualidade da sensação. A <Link href="/ansiedade" className="text-primary hover:underline">ansiedade</Link> pura, baseada no medo e em padrões de repetição do passado, é caótica, desesperadora e paralisante. Ela faz você imaginar os piores cenários e te deixa em um estado de exaustão mental. Já a intuição, por mais que traga uma verdade desconfortável (como "preciso mudar de vida"), é sempre acompanhada de uma sensação de clareza e de uma calma profunda no fundo do peito.
      </p>
      ...
      <p>
        Tentar curar a <Link href="/ansiedade" className="text-primary hover:underline">ansiedade</Link> apenas com pensamento positivo é como desligar o alarme de incêndio enquanto a casa continua pegando fogo. O sintoma só desaparece quando você compreende a mensagem que ele traz.
      </p>
