...
export default function RepeticaoPadroesFamiliares() {
  useEffect(() => {
    document.title = 'Repetição de padrões familiares em relacionamentos amorosos: Por que você escolhe o que machuca | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Descubra por que você atrai parceiros que repetem padrões familiares.');
  }, []);
