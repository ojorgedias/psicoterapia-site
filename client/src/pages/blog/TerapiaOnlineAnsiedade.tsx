...
Quando essa transição dói a ponto de paralisar o seu domingo, ela deixou de ser um "cansaço normal" e se tornou o sintoma de uma profunda <a href="/crise-existencial" className="text-blue-600 hover:underline"><Link href="/crise-existencial"><a className="text-primary hover:underline">crise existencial</a></Link> e falta de propósito</a>. O seu corpo está informando que a distância entre quem você é no domingo e quem você é obrigado a ser na segunda-feira tornou-se insustentável.</h2><p className="text-slate-700 leading-relaxed mb-6">Muitas pessoas tentam anestesiar esse desconforto consumindo álcool no domingo à noite, maratonando séries ou caindo em ciclos de <Link href="/autossabotagem"><a className="text-primary hover:underline">autossabotagem</a></Link> e padrões de repetição. Mas a fuga apenas agrava a desorientação.</p><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">A integração do sujeito
