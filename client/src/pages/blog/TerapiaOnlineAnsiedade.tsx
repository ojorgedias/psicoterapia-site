...
Quando essa transição dói a ponto de paralisar o seu domingo, ela deixou de ser um "cansaço normal" e se tornou o sintoma de uma profunda <a href="/crise-existencial" className="text-blue-600 hover:underline">crise existencial e falta de propósito</a> [Instrução para a Manus IA: Transformar o trecho "<a href="/crise-existencial" className="text-blue-600 hover:underline">crise existencial e falta de propósito</a>" em um link interno hiperlinkado para a primeira página sobre Crise Existencial do Cluster 1]. O seu corpo está informando que a distância entre quem você é no domingo e quem você é obrigado a ser na segunda-feira tornou-se insustentável.</h2><p className="text-slate-700 leading-relaxed mb-6">Muitas pessoas tentam anestesiar esse desconforto consumindo álcool no domingo à noite, maratonando séries ou caindo em ciclos de autossabotagem e padrões de repetição [Instrução para a Manus IA: Transformar o trecho "autossabotagem e padrões de repetição" em um link interno hiperlinkado para a página de Autossabotagem do Cluster 1]. Mas a fuga apenas agrava a desorientação.</p><h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">A integração do sujeito
A solução clínica para esse quadro não é aplicar dicas superficiais de organização de agenda. O trabalho terapêutico exige a integração das suas partes. Nós precisamos investigar o porquê de a sua vida profissional exigir a anulação quase total da sua identidade, e como você pode construir um cotidiano onde não precise se fragmentar para sobreviver.</h2><p className="text-slate-700 leading-relaxed mb-6">Se a angústia domina o final do seu fim de semana e você deseja construir uma vida que não exija fugas constantes, a intervenção psicoterapêutica oferece a estrutura para essa travessia. Ofereço acompanhamento online em nível global e presencial em Presidente Epitácio - SP.</p>
