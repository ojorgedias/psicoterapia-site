...
export default function TerapiaOnlineAnsiedade() {
  useEffect(() => {
    document.title = 'Terapia online para ansiedade generalizada funciona? A eficácia do tratamento clínico | Jorge Dias';
    ...
    descMeta.setAttribute('content', 'Descubra como a terapia online oferece o mesmo rigor das sessões presenciais.');
  }, []);
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        <section className="pt-20 pb-12 px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-slate-900 mb-6 leading-tight">
            Terapia online para ansiedade generalizada funciona? A eficácia do tratamento clínico
          </h1>
        </section>
