...
<p className="text-lg leading-relaxed">
            ...
            Que você sente <Link className="text-primary hover:underline" href="/ansiedade">ansiedade</Link> quando deveria estar feliz? Que há uma culpa inexplicável associada 
...
<Link href="/terapia/adultos/regulacao-emocional"></Link>
