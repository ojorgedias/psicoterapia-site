...
export default function IntegracaoPsicologiaEspiritualidade() {
  ...
  return (
    ...
    <div className="bg-background">
      <Breadcrumbs items={[{ label: 'Blog', href: '/blog' }, { label: 'Integração Psicologia-Espiritualidade' }]} />
      ...
      <article className="container max-w-3xl py-12 md:py-20">
        ...
        <div className="prose prose-invert max-w-none text-foreground space-y-6">
          ...
          <p>
            ...
            trauma não processado. Uma dificuldade em práticas espirituais pode ser autossabotagem. Uma 
            "noite escura da alma" pode ser depressão.
          </p>
          ...
          <h2 className="text-2xl font-display font-bold text-foreground mt-8">
            Autossabotagem em Práticas Espirituais
          </h2>
          <p>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-6 mt-8">
            ...
            <p className="text-foreground mb-4">
              ...
              com foco em crescimento genuíno sem spiritual bypass.
            </p>
